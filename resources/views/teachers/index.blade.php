...
<div id="edit-teacher-modal" class="hidden fixed inset-0 z-[9999] flex items-center justify-center">
    ...
    <div class="relative mx-4 w-full max-w-2xl rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
        ...
        <form method="POST" id="edit-teacher-form" class="grid grid-cols-1 gap-4 md:grid-cols-2" autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-1 col-span-1 md:col-span-2">
                ...
                <div class="relative w-full">
                    <input name="password" id="edit-teacher-password" type="password" class="w-full rounded-xl border border-slate-300 pl-3 pr-10 py-2 text-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500" placeholder="Password (opsional)" autocomplete="new-password" />
