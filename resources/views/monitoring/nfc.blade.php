        ...
        <section class="flex min-h-0 flex-col lg:col-span-9 lg:overflow-hidden">
            <div class="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:p-5">
                <div class="flex shrink-0 flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        <h2 class="text-lg font-bold text-slate-900 lg:text-xl">Event Stream (Real-Time)</h2>
                        <p class="mt-1 text-xs text-slate-500 lg:text-sm">Monitoring tap-in siswa secara real-time</p>
                    </div>
                ...
                <div class="mt-3 grid shrink-0 grid-cols-2 gap-2 sm:grid-cols-4 lg:mt-4 lg:gap-3">
                    <div class="rounded-xl border border-slate-100 bg-gradient-to-br from-slate-50 to-white p-3 lg:p-4">
                        ...
                        <p class="mt-1 text-2xl font-bold tabular-nums text-slate-900 lg:text-3xl">{{ $totalScans }}</p>
                    </div>
                    <div class="rounded-xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-3 lg:p-4">
                        ...
                        <p class="mt-1 text-2xl font-bold tabular-nums text-emerald-900 lg:text-3xl">{{ $successCount }}</p>
                        <p class="mt-0.5 text-xs text-emerald-800/90 lg:text-sm">{{ $successRate }}% Success Rate</p>
                    </div>
                    <div class="rounded-xl border border-red-100 bg-gradient-to-br from-red-50 to-white p-3 lg:p-4">
                        ...
                        <p class="mt-1 text-2xl font-bold tabular-nums text-red-900 lg:text-3xl">{{ $failedCount }}</p>
                        <p class="mt-0.5 text-xs text-red-800/90 lg:text-sm">{{ $errorRate }}% Error Rate</p>
                    </div>
                    <div class="rounded-xl border border-amber-100 bg-gradient-to-br from-amber-50 to-white p-3 lg:p-4">
                        ...
                        <p class="mt-1 text-2xl font-bold tabular-nums text-amber-900 lg:text-3xl">{{ $unknownCount }}</p>
