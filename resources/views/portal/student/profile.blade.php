    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-500 to-sky-700 p-6 text-white">
        ...
        <div class="relative flex flex-col items-center text-center">
            <div class="relative">
                ...
                <span class="absolute right-0 top-0 flex h-8 w-8 items-center justify-center rounded-full bg-emerald-400 shadow-lg ring-4 ring-sky-600">
            ...
            <div class="mt-4 flex flex-wrap items-center justify-center gap-2">
                ...
                @if($photoUrl)
                    <button type="button" id="photo-delete-btn" class="inline-flex items-center gap-2 rounded-full bg-rose-500/90 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-rose-600">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="mt-2 text-xs text-sky-100/90">Ketuk avatar atau tombol di bawah untuk mengganti foto profil.</p>
...
(function () {
    ...
    deleteBtn?.addEventListener('click', function () {
        if (confirm('Hapus foto profil sekarang?')) {
            ...
            deleteBtn.innerHTML = '<svg class="h-4 w-4 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg> Menghapus...';
            ...
            .then(function (data) {
                ...
                alert('Gagal menghapus foto profil: ' + (data.message || 'Respons tidak valid'));
            })
            ...
            .finally(function () {
                ...
                deleteBtn.innerHTML = '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg> Hapus Foto';
            });
        }
    });
